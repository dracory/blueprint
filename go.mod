...
require (
	...
	github.com/dracory/blogstore v1.5.0
	...
	github.com/dracory/cmsstore v1.12.0
	github.com/dracory/crud/v2 v2.0.0-20260211155951-8319e6826160
...
require (
	...
	github.com/goravel/framework v1.17.1 // indirect
