...
func TestRender_Success(t *testing.T) {
	...
	if !strings.Contains(html, "media-wrapper") {
		t.Error("expected HTML to contain media-wrapper div")
	}
...
func TestRender_ContainsFormWrapper(t *testing.T) {
	...
	if !strings.Contains(html, "FormProductMediaUpdate") {
...
func TestRender_ContainsInitScript(t *testing.T) {
	...
	if !strings.Contains(html, "urlMediaLoad") {
		t.Error("expected HTML to contain urlMediaLoad variable")
	}
	if !strings.Contains(html, "urlMediaSave") {
		t.Error("expected HTML to contain urlMediaSave variable")
	}
}
