...
func TestRender_Success(t *testing.T) {
	...
	if !strings.Contains(html, "tags-wrapper") {
		t.Error("expected HTML to contain tags-wrapper div")
	}
...
func TestRender_ContainsFormWrapper(t *testing.T) {
	...
	if !strings.Contains(html, "FormProductTagsUpdate") {
...
func TestRender_ContainsInitScript(t *testing.T) {
	...
	if !strings.Contains(html, "urlTagsLoad") {
		t.Error("expected HTML to contain urlTagsLoad variable")
	}
	if !strings.Contains(html, "urlTagsSave") {
		t.Error("expected HTML to contain urlTagsSave variable")
	}
}
