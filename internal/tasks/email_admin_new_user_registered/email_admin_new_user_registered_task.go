...
//
// =================================================================
func NewEmailToAdminOnNewUserRegisteredTaskHandler(app app.AppInterface) *emailToAdminOnNewUserRegisteredTaskHandler {
...
func (handler *emailToAdminOnNewUserRegisteredTaskHandler) Alias() string {
	return constants.EmailToAdminOnNewUserRegisteredTaskAlias
}
...
func (handler *emailToAdminOnNewUserRegisteredTaskHandler) Handle() bool {
	...
	err := emails.NewEmailToAdminOnNewUserRegistered(handler.app).Send(user.GetID())
