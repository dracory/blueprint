...
func LoginAs(app app.AppInterface, r *http.Request, user userstore.UserInterface) (*http.Request, error) {
...
func CallStringHandlerAsUser(app app.AppInterface, method string, handler func(http.ResponseWriter, *http.Request) string, options test.NewRequestOptions, userID string) (body string, response *http.Response, err error) {
