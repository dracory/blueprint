...
func NewAiPostEditorController(app app.AppInterface) *AiPostEditorController {
...
func (c *AiPostEditorController) view(data pageData) *hb.Tag {
	...
	breadcrumbs := layouts.Breadcrumbs([]layouts.Breadcrumb{
		...
		{
			Name: "Post Editor",
			URL:  shared.NewLinks("/admin/blog").AiPostEditor(),
		},
		{
			Name: "Post Editor",
			URL:  shared.NewLinks("/admin/blog").AiPostEditor(map[string]string{"id": data.BlogAiPost.ID}),
		},
	})
